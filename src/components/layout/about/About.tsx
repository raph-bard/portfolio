...
const About = ({ className } : AboutProps) => {
    ...
    return (
        <div className={className}>
            ...
            <p className="mb-4 leading-normal">Fort d’un parcours en intégration web (HTML, CSS, WordPress, Prestashop), j&apos;ai continué avec passion dans le développement front-end moderne. Je travaille aujourd’hui avec Next.js, TypeScript, TailwindCSS et Storybook pour construire des interfaces réactives, accessibles, structurées et bien documentées.</p>
